...
link_binary() {
  ...
  ln -sf "$INSTALL_DIR/cli-dev" "$link_dir/free-fix"
  ln -sf "$INSTALL_DIR/cli-dev" "$link_dir/free-code"
  ok "Symlinked: $link_dir/free-fix"
...
printf "    ${CYAN}free-fix${RESET}                           # interactive REPL\n"
printf "    ${CYAN}free-fix -p \"your prompt\"${RESET}           # one-shot mode\n"
echo ""
