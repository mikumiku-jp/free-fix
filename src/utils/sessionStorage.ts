...
export function isLoggableMessage(m: Message): boolean {
  ...
  // When enabled, we allow a small safe subset through:
  // - hook_additional_context: user-configured hook output needed on resume
  // - *_delta attachment state: cache-stability control-plane state that must
